...
const skillCategories = [
  ...
  {
    title: 'AI/ML',
    skills: ['PyTorch', 'TensorFlow', 'Scikit-learn', 'Pandas', 'NumPy', 'OpenAI API'],
    color: 'from-orange-500 to-red-500',
  },
  {
    title: 'Data Science',
    skills: ['Power BI', 'Tableau', 'Data Visualization', 'Statistical Analysis'],
    color: 'from-yellow-500 to-amber-500',
  },
  {
    title: 'DevOps & Tools',
    skills: ['Git', 'Docker', 'Linux', 'AWS', 'Redis', 'SQLite'],
    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        {category.skills.map((skill) => (
          <span
            key={skill}
            className="px-3 py-1 bg-slate-700/50 text-slate-300 text-sm rounded-lg hover:bg-slate-600 transition-colors cursor-default"
          >
            {skill}
          </span>
        ))}
